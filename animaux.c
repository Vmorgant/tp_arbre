...
main( int argc  , char * argv[] ) 
{
  ...
  printf("Affichage\n\n") ; 
  ab_animaux_afficher( arbre , string_string_afficher_cb,parcours ) ; 
  printf( "\n");
  ...
  while( continuer )
    {
      ab_animaux_reconnaitre( arbre , string_copier_cb , string_string_afficher_cb,parcours ) ; 
