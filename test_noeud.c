...
main()
{
  ...
  noeud_fg = noeud_creer( 2 , individu_2 , NULL , NULL , individu_copier_cb ) ;
  noeud_fd = noeud_creer( 3 , individu_3 , NULL , NULL , individu_copier_cb ) ;
  noeud    = noeud_creer( 1 , individu_1 , noeud_fg , noeud_fd , individu_copier_cb ) ;

  printf( "Test affichage noeud\n" ) ;
  noeud_afficher( noeud , individu_afficher_cb, 0 ) ;
  printf( "\n");
